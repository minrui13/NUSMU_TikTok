      ...
      >
        <TableHead className="audit-log-table-head single">
          <TableRow className="audit-log-table-row">
            <TableCell className="audit-log-table-cell single">Time</TableCell>
            <TableCell className="audit-log-table-cell single">Agent</TableCell>
            <TableCell className="audit-log-table-cell single">User</TableCell>
            <TableCell className="audit-log-table-cell single">
              Action
            </TableCell>
            <TableCell className="audit-log-table-cell single">Risk</TableCell>
            <TableCell className="audit-log-table-cell single">
              Decision
            </TableCell>
            <TableCell className="audit-log-table-cell single">
